...
{{
    "metrics": [
        {{"name": "指标名", "type": "类型", "unit": "单位", "description": "描述"}}
    ],
    "collection": "收集方案",
    "storage": "存储方案",
    "tools": ["推荐工具"]
...
def create_tools(**kwargs) -> AIMetricsCollectorTools:
    """创建指标收集工具"""
    return AIMetricsCollectorTools(**kwargs)


if __name__ == "__main__":
    tools = create_tools()

    print("AI Metrics Collector Tools")
    print()

    # 测试
    system = tools.design_metrics_system("电商应用", ["转化率", "留存率", "ARPU"])
